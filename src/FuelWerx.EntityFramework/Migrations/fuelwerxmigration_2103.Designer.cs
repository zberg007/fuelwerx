...
namespace FuelWerx.Migrations
{
	...
	public sealed class fuelwerxmigration_2103 : DbMigration, IMigrationMetadata
	{
		private readonly ResourceManager Resources = new ResourceManager(typeof(fuelwerxmigration_2103));

		string System.Data.Entity.Migrations.Infrastructure.IMigrationMetadata.Id
		{
			get
			{
				return "201604240621105_fuelwerxmigration_2103";
			}
		}
		...
		public fuelwerxmigration_2103()
		{
		}

		public override void Down()
		{
			base.DropForeignKey("dbo.FuelWerxEstimateAdhocProducts", "EstimateId", "dbo.FuelWerxEstimates", null);
			base.DropIndex("dbo.FuelWerxEstimateAdhocProducts", new string[] { "EstimateId" }, null);
			base.DropTable("dbo.FuelWerxEstimateAdhocProducts", new Dictionary<string, object>()
			{
				{ "DynamicFilter_EstimateAdhocProduct_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" }
			}, null);
		}
		...
		public override void Up()
		{
			...
			base.CreateTable("dbo.FuelWerxEstimateAdhocProducts", (ColumnBuilder c) => {
				long? nullable = null;
