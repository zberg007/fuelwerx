...
namespace FuelWerx.Migrations
{
	...
	public sealed class FuelWerxMigration_2095 : DbMigration, IMigrationMetadata
	{
		private readonly ResourceManager Resources = new ResourceManager(typeof(FuelWerxMigration_2095));

		string System.Data.Entity.Migrations.Infrastructure.IMigrationMetadata.Id
		{
			get
			{
				return "201607080400019_FuelWerxMigration_2095";
			}
		}
		...
		public FuelWerxMigration_2095()
		{
		}

		public override void Down()
		{
			base.DropForeignKey("dbo.FuelWerxEstimateAdjustments", "EstimateId", "dbo.FuelWerxEstimates", null);
			base.DropIndex("dbo.FuelWerxEstimateAdjustments", new string[] { "EstimateId" }, null);
			base.DropTable("dbo.FuelWerxEstimateAdjustments", new Dictionary<string, object>()
			{
				{ "DynamicFilter_EstimateAdjustment_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" }
			}, null);
		}
		...
		public override void Up()
		{
			...
			base.CreateTable("dbo.FuelWerxEstimateAdjustments", (ColumnBuilder c) => {
				long? nullable = null;
