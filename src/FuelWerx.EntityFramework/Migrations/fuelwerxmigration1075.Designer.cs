...
namespace FuelWerx.Migrations
{
	...
	public sealed class fuelwerxmigration1075 : DbMigration, IMigrationMetadata
	{
		private readonly ResourceManager Resources = new ResourceManager(typeof(fuelwerxmigration1075));

		string System.Data.Entity.Migrations.Infrastructure.IMigrationMetadata.Id
		{
			get
			{
				return "201603260700050_fuelwerxmigration1075";
			}
		}
		...
		public fuelwerxmigration1075()
		{
		}

		public override void Down()
		{
			base.DropForeignKey("dbo.FuelWerxZoneTaxes", "ZoneId", "dbo.FuelWerxZones", null);
			base.DropForeignKey("dbo.FuelWerxZoneTaxes", "TaxId", "dbo.FuelWerxTaxes", null);
			base.DropIndex("dbo.FuelWerxZoneTaxes", new string[] { "TaxId" }, null);
			base.DropIndex("dbo.FuelWerxZoneTaxes", new string[] { "ZoneId" }, null);
			base.DropTable("dbo.FuelWerxZoneTaxes", new Dictionary<string, object>()
			{
				{ "DynamicFilter_ZoneTax_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" }
			}, null);
		}
		...
		public override void Up()
		{
			...
			base.CreateTable("dbo.FuelWerxZoneTaxes", (ColumnBuilder c) => {
				long? nullable = null;
				...
				nullable1 = null;
				nullable = null;
				return new { Id = columnModel, ZoneId = columnModel1, TaxId = columnModel2, IsActive = columnModel3, IsDeleted = columnModel4, DeleterUserId = columnModel5, DeletionTime = columnModel6, LastModificationTime = columnModel7, LastModifierUserId = columnModel8, CreationTime = c.DateTime(new bool?(false), nullable2, nullable3, null, null, null, null), CreatorUserId = c.Long(nullable1, false, nullable, null, null, null, null) };
			}, strs, null).PrimaryKey((t) => t.Id, null, true, null).ForeignKey("dbo.FuelWerxTaxes", (t) => t.TaxId, true, null, null).ForeignKey("dbo.FuelWerxZones", (t) => t.ZoneId, true, null, null).Index((t) => t.ZoneId, null, false, false, null).Index((t) => t.TaxId, null, false, false, null);
		}
	}
}