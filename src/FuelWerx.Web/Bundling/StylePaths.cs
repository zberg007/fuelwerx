...
namespace FuelWerx.Web.Bundling
{
	public static class StylePaths
	{
		...
		public const string JQuery_jTable_Theme = "~/libs/jquery-jtable/themes/lightcolor/gray/jtable.min.css";

		public const string JQuery_Multi_Select = "~/libs/jquery-multiselect/css/multi-select.min.css";
	}
}